...
const DadosPessoais = () => {
  ...
  return (
      <form style={{ textAlign: 'center' }} onSubmit={finalizarCadastro}>
        ...
        <Row>
          ...
          <Col lg={6} md={6} sm={6}>
            <CampoTexto titulo="Repita a Senha" tipo="password" valor={usuario.senhaConfirmada} onChange={setSenhaConfirmada} />
          </Col>
        </Row>
